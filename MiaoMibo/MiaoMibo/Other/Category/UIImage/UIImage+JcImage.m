...
//高效添加圆角图片
- (UIImage*)Jc_imageAddCornerWithRadius:(CGFloat)radius andSize:(CGSize)size{
...
//截屏
+(instancetype)Jc_snapshotCurrentScreen{
...
+ (UIImage *)imageWithName:(UIImage *)image border:(CGFloat)border borderColor:(UIColor *)color
{
    // 圆环的宽度
...
+(UIImage *)Jc_GetRoundImagewithImage:(UIImage *)image {
